...
var fileDescriptor_e6bf2142de248303 = []byte{
	...
	0x7a, 0x50, 0x5a, 0x29, 0x8a, 0x8b, 0x2d, 0x08, 0xcc, 0x14, 0x92, 0xe0, 0x62, 0x4f, 0x2e, 0x4a,
	...
	0x58, 0x52, 0x12, 0x4b, 0x12, 0x25, 0x98, 0xc1, 0xca, 0xc0, 0x6c, 0x90, 0x58, 0x6e, 0x6a, 0x49,
	0xa2, 0x04, 0x0b, 0x44, 0x0c, 0xc4, 0x76, 0x32, 0x3c, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39,
	0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63,
	0x39, 0x86, 0x28, 0x71, 0x98, 0xe3, 0x2a, 0xe0, 0xce, 0x2c, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62,
	0x03, 0x3b, 0xd3, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x71, 0x02, 0x80, 0x21, 0xc6, 0x00, 0x00,
	0x00,
}
...
func (m *Recipe) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Meta) > 0 {
		i -= len(m.Meta)
		copy(dAtA[i:], m.Meta)
		i = encodeVarintRecipe(dAtA, i, uint64(len(m.Meta)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Data) > 0 {
		i -= len(m.Data)
		copy(dAtA[i:], m.Data)
		i = encodeVarintRecipe(dAtA, i, uint64(len(m.Data)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
